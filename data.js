...
$$I_{D2} = I_{D1}-I = 3{,}96-0{,}2 = \\boxed{3{,}76\\,[mA]}$$`
...

  {
    ...
    tags: ["tranzistor","BJT","regim activ normal","RAN","saturatie","RS","blocat","RB","regim activ invers","RAI","intreruptor inchis","intreruptor deschis","amplificare","UCEsat","jonctiune EB","jonctiune BC","polarizare directa","polarizare inversa"],
...

  {
    ...
    tags: ["tranzistor","BJT","PSF","punct static de functionare","dreapta de sarcina","polarizare","R1 R2 RC RE","stabilizare termica","ambalare termica","ICBo","divizor tensiune baza","VB","UBE","reactie negativa","temperatura"],
...

  {
    ...
    tags: ["tranzistor","BJT","parametri hibrizi","h11","h12","h21","h22","semnal mic","emitor comun","EC","cuadripol","impedanta intrare","transfer tensiune","amplificare dinamica","admitanta iesire","beta ac","model liniar"],
